...
import com.tirsen.nanning.prevayler.*;
...
public class PrevaylerTest extends AbstractAttributesTest {
    ...
    public void test() throws IOException, ClassNotFoundException {
        ...
        ((com.tirsen.nanning.prevayler.CheckpointPrevayler) prevayler.getWrappedPrevayler()).checkpoint();
        checkMySystem();
    }
...
//    }
    ...
    private CountingPrevayler newPrevayler() throws IOException, ClassNotFoundException {
        CountingPrevayler prevayler = new CountingPrevayler(new com.tirsen.nanning.prevayler.CheckpointPrevayler(aspectFactory.newInstance(MySystem.class),
