...
import com.tirsen.nanning.definition.AttributePointcut;
...
public class CacheTest extends AbstractAttributesTest {
    ...
    public void testCacheCounter() {
        ...
        CacheCounterAdvise counter = new CacheCounterAdvise(new CacheInterceptor());
        aspectSystem.addPointcut(new AttributePointcut("cache", counter));
