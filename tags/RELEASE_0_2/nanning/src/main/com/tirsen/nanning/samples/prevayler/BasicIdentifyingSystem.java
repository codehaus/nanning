...
public class BasicIdentifyingSystem implements IdentifyingSystem {
    ...
    public synchronized long registerObjectID(Object object) {
        assert nextObjectId > 28 ? CurrentPrevayler.isInTransaction() : true :
                "can't register IDs outside transaction, use NodeService.newInstance(Class) instead (next object id " + nextObjectId + ")";
